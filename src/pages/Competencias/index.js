      ...
      <div className="my-10">
        <div className="flex flex-col w-full lg:flex-row">
          <div className="grid w-full lg:w-[50%] p-5 place-items-start">
            ...
            <ul>
              ...
              <li className="my-5 ml-2 text-lg">
                ...
                {" "}
                <span className="text-accent">Arduino</span> em projetos de IOT;
              </li>
              <li className="my-5 ml-2 text-lg">
                <span className="text-accent-focus">✦</span> Conhecimento de:
                {" "}
          ...
          <div className="grid w-full lg:w-[50%] p-5 place-items-start">
            ...
            <ul>
              ...
              <li className="my-5 ml-2 text-lg">
                <span className="text-accent-focus">✦</span>{" "}
                Experiência na impressão de modelos 3D em impressoras de resina
                e de filamento.
              </li>
            </ul>
          </div>
        ...
        <div className="flex flex-col w-full lg:flex-row">
          <div className="grid w-full lg:w-[50%] p-5 place-items-start">
            ...
            <ul>
              <li className="my-5 ml-2 text-lg">
                <span className="text-secondary-focus">✦</span> Inglês fluente;
              </li>
              <li className="my-5 ml-2 text-lg">
